...
git clone https://github.com/AsimAftab/kiro-gateway.git
cd kiro-gateway
...
docker run -d \
  ...
  --name kiro-gateway \
  ghcr.io/AsimAftab/kiro-gateway:latest
```
...
```bash
docker run -d -p 8000:8000 --env-file .env --name kiro-gateway ghcr.io/AsimAftab/kiro-gateway:latest
```
