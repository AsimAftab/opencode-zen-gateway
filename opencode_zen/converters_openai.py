...
from opencode_zen.config import HIDDEN_MODELS
from opencode_zen.model_resolver import get_model_id_for_kiro
from opencode_zen.models_openai import ChatMessage, ChatCompletionRequest, Tool
...
from opencode_zen.converters_core import (
    ...
    UnifiedTool,
    ThinkingConfig,
    build_opencode_payload as core_build_opencode_payload,
)
