...
from opencode_zen.parsers import parse_bracket_tool_calls, deduplicate_tool_calls
from opencode_zen.utils import generate_completion_id
from opencode_zen.config import (
    FIRST_TOKEN_TIMEOUT,
    FIRST_TOKEN_MAX_RETRIES,
    FAKE_REASONING_HANDLING,
)
from opencode_zen.tokenizer import count_tokens, count_message_tokens, count_tools_tokens
...
async def stream_kiro_to_openai_internal(
    ...
    try:
        ...
        from opencode_zen.truncation_state import save_tool_truncation, save_content_truncation
