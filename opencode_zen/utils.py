...
"""
Utility functions for OpenCode Zen Gateway.
...
def get_machine_fingerprint() -> str:
    ...
    Returns:
        SHA256 hash of the string "{hostname}-{username}-opencode-zen-gateway"
    """
    try:
        import socket
        import getpass
        ...
        unique_string = f"{hostname}-{username}-opencode-zen-gateway"
