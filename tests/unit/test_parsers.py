...
Tests the parsing logic for AWS SSE stream from OpenCode API.
"""

import pytest

from opencode_zen.parsers import (
...
class TestDiagnoseJsonTruncation:
    ...
    This method helps distinguish upstream issues (OpenCode API truncates large
