...
class TestExtractQueryFromMessages:
    ...
    def test_extract_query_anthropic_list_content(self):
        ...
        from opencode_zen.models_anthropic import AnthropicMessage, TextContentBlock
    ...
    def test_extract_query_no_text_content(self):
        ...
        from opencode_zen.models_anthropic import AnthropicMessage, ImageContentBlock, Base64ImageSource
        messages = [AnthropicMessage(
            role="user",
