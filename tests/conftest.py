...
"""
Common fixtures and utilities for testing OpenCode Zen Gateway.
...
def valid_proxy_api_key():
    ...
    This reads the value from opencode_zen.config, which was loaded when the app
...
def aws_event_parser():
    ...
    """
    from opencode_zen.parsers import AwsEventStreamParser
